    ...
    <div class="h-full px-3 pb-32 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            @can('admin')
                ...
                <li>
                    <a href="{{route('admin.seller.list')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{request()->routeIs('admin.seller.list') ? "bg-gray-100 dark:bg-gray-700" : ""}}">
                        Vendedor
                    </a>
                </li>
            @endcan
            ...
            @can('seller')
                {{-- <li>
                    <a href="{{route('seller.user.list')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{request()->routeIs('seller.user.list') ? "bg-gray-100 dark:bg-gray-700" : ""}}">
                        Clientes
                    </a>
                </li> --}}
                <li>
                    <a href="{{route('seller.order.list')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{request()->routeIs('seller.order.list') ? "bg-gray-100 dark:bg-gray-700" : ""}}">
                        Pedidos
                    </a>
                </li>
                <li>
                    <a href="{{route('seller.order.new')}}" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{request()->routeIs('seller.order.new') ? "bg-gray-100 dark:bg-gray-700" : ""}}">
                        Nova Ordem
                    </a>
                </li>
            @endcan
